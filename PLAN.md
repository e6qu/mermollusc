...
| `@m/builder` | ✅ hit-test, selection, overrides (move + connector re-anchor + extent growth), two-way relabel/add/connect/delete-node/delete-edge · sidecar group model (nestable, move-only lock) · overlay codec (persist) (+ property-based) | 41 |

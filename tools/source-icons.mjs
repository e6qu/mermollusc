...
const PACKS = {
  ...
  devicon: {
    ...
    icons: {
      ...
      swift: "icons/swift/swift-original.svg",
      dotnetcore: "icons/dotnetcore/dotnetcore-original.svg",
      react: "icons/react/react-original.svg",
      vuejs: "icons/vuejs/vuejs-original.svg",
      angular: "icons/angular/angular-original.svg",
      svelte: "icons/svelte/svelte-original.svg",
      nextjs: "icons/nextjs/nextjs-original.svg",
      nodejs: "icons/nodejs/nodejs-original.svg",
      django: "icons/django/django-plain.svg",
      flask: "icons/flask/flask-original.svg",
      spring: "icons/spring/spring-original.svg",
      rails: "icons/rails/rails-plain.svg",
      express: "icons/express/express-original.svg",
      graphql: "icons/graphql/graphql-plain.svg",
      npm: "icons/npm/npm-original.svg",
      webpack: "icons/webpack/webpack-original.svg",
      vite: "icons/vite/vite-original.svg",
    },
  },
  ...
  // kubernetes/community: Apache-2.0. The official k8s *resource* shapes (unlabeled) — pod,
  // deployment, service, … — the proper icons for k8s architecture diagrams.
  k8s: {
    repo: "kubernetes/community",
    ref: "8b03bb61ff9b1e76ec42b413830bd743e892ae3c",
    license: "Apache-2.0",
    icons: {
      pod: "icons/svg/resources/unlabeled/pod.svg",
      deploy: "icons/svg/resources/unlabeled/deploy.svg",
      svc: "icons/svg/resources/unlabeled/svc.svg",
      ing: "icons/svg/resources/unlabeled/ing.svg",
      cm: "icons/svg/resources/unlabeled/cm.svg",
      secret: "icons/svg/resources/unlabeled/secret.svg",
      ns: "icons/svg/resources/unlabeled/ns.svg",
      pv: "icons/svg/resources/unlabeled/pv.svg",
      pvc: "icons/svg/resources/unlabeled/pvc.svg",
      sts: "icons/svg/resources/unlabeled/sts.svg",
      ds: "icons/svg/resources/unlabeled/ds.svg",
      rs: "icons/svg/resources/unlabeled/rs.svg",
      job: "icons/svg/resources/unlabeled/job.svg",
      cronjob: "icons/svg/resources/unlabeled/cronjob.svg",
      hpa: "icons/svg/resources/unlabeled/hpa.svg",
      sa: "icons/svg/resources/unlabeled/sa.svg",
      role: "icons/svg/resources/unlabeled/role.svg",
      rb: "icons/svg/resources/unlabeled/rb.svg",
      crd: "icons/svg/resources/unlabeled/crd.svg",
      netpol: "icons/svg/resources/unlabeled/netpol.svg",
      quota: "icons/svg/resources/unlabeled/quota.svg",
      ep: "icons/svg/resources/unlabeled/ep.svg",
      vol: "icons/svg/resources/unlabeled/vol.svg",
      sc: "icons/svg/resources/unlabeled/sc.svg",
      node: "icons/svg/infrastructure_components/unlabeled/node.svg",
    },
  },
};

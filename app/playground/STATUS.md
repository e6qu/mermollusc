...
- Playwright (`make e2e-ui`): 13 flows — load, edit, click, flowchart relabel,
  drag→relax→regenerate, sequence render, sequence relabel, add-node, connect, delete,
  C4 render, C4 relabel, block render.
- Not yet: block two-way edit; CodeMirror editor; HTML-in-Canvas.

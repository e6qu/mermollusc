...
**State:** interactive editor; renders **flowchart, sequence, C4, block, network, cloud, state, ER** (ER with crow's-foot cardinality + attribute compartments); `make check` + Playwright (82 specs) green.
